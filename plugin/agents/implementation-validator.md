...
## Input
The **scope** just built (from the orchestrating command or build): a PRD, a phase of task IDs, or all in-scope work. Read the relevant `gspec/features/*.md` + `gspec/tasks/*.md`, `gspec/architecture.md` (Modules), and `gspec/practices.md` (Definition of Done) yourself.
